...
describe('QuantitySelector Component', () => {
  ...
  describe('Loading State', () => {
    it('shows loading spinner when loading is true', () => {
      const { container } = render(
        <QuantitySelector initialQuantity={5} loading={true} onChange={mockOnChange} />
      );
  ...
  describe('Stock Status', () => {
    it('allows quantity changes when in stock', () => {
      render(
        <QuantitySelector initialQuantity={1} stockStatus="instock" onChange={mockOnChange} />
      );
      const incrementButton = screen.getByLabelText('Increase quantity');
    ...
    it('allows quantity changes when on backorder', () => {
      render(
        <QuantitySelector initialQuantity={1} stockStatus="onbackorder" onChange={mockOnChange} />
      );
      const incrementButton = screen.getByLabelText('Increase quantity');
