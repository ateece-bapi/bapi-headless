...
const MegaMenuItemComponent: React.FC<MegaMenuItemProps> = ({
  ...
  if (!item.megaMenu) {
    return (
      <Link
        href={item.href || '#'}
        className="group relative inline-flex items-center gap-1.5 rounded-md px-4 py-2.5 text-base font-semibold text-neutral-700 transition-all duration-300 ease-out hover:bg-primary-600 hover:text-white hover:shadow-sm"
      >
        {item.label}
        <span className="absolute bottom-0 left-1/2 h-0.5 w-0 -translate-x-1/2 bg-primary-400 transition-all duration-300 ease-out group-hover:w-1/2" />
      </Link>
    );
  }
  ...
  return (
    <div className="relative">
        ...
        <Link
          ...
          className={clsx(
            ...
            isOpen
              ...
              : 'text-neutral-700 hover:bg-primary-600 hover:text-white hover:shadow-sm',
            'cursor-pointer'
          )}
        >
      ...
      >
                      ...
                      {column.links.map((link, linkIndex) => (
                        <li key={`${link.href}-${link.label}-${linkIndex}`}>
                          <Link
                            ...
                            className="group block rounded-lg border border-transparent bg-white p-2.5 transition-all duration-300 ease-out hover:border-primary-200 hover:bg-primary-50 hover:shadow-sm focus:outline-none focus-visible:bg-primary-50 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
                          >
                            <div className="flex items-start justify-between gap-2">
                              <span className="text-sm font-bold text-neutral-900 transition-colors duration-300 ease-out group-hover:text-primary-700">
                                {link.label}
                              </span>
                              {link.badge && (
          ...
          {item.megaMenu.featured && (
            <div className="md:col-span-3">
              ...
              >
                ...
                <div
                  className="absolute inset-0 animate-pulse bg-[radial-gradient(circle_at_50%_50%,rgba(255,200,67,0.3)_0%,transparent_70%)]"
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  {/* Social Proof */}
                  <div className="flex items-center gap-2 rounded-lg border border-primary-200/50 bg-white/60 px-3 py-2 backdrop-blur-sm">
                    <div className="flex -space-x-2">
                      <div className="h-6 w-6 rounded-full border-2 border-white bg-primary-500" />
                      <div className="h-6 w-6 rounded-full border-2 border-white bg-primary-400" />
                      <div className="h-6 w-6 rounded-full border-2 border-white bg-primary-600" />
                    </div>
                  ...
                  <Link
                    ...
                    onClick={onCloseImmediate}
                    className="group flex w-full items-center justify-center gap-2 rounded-lg bg-primary-600 px-5 py-3 text-base font-black text-white shadow-lg transition-all duration-200 hover:scale-105 hover:bg-primary-700 hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 focus-visible:ring-offset-2"
                  >
        ...
        <div className="mt-6 border-t-2 border-neutral-100 pt-6">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <div className="flex flex-wrap gap-2">
              <Link
                href="/contact-sales"
                onClick={onCloseImmediate}
                className="inline-flex items-center gap-1.5 rounded-md border border-primary-200 bg-primary-50 px-3 py-1.5 text-xs font-bold text-primary-700 transition-colors hover:border-primary-300 hover:bg-primary-100"
              >
              ...
              <Link
                href="/where-to-buy"
                onClick={onCloseImmediate}
                className="inline-flex items-center gap-1.5 rounded-md border border-neutral-200 bg-neutral-50 px-3 py-1.5 text-xs font-bold text-neutral-700 transition-colors hover:border-neutral-300 hover:bg-neutral-100"
              >
                <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
