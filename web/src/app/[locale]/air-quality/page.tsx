      ...
      <section id="co2-sensors" className="bg-neutral-50 py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-4xl text-lg text-neutral-600">{t('co2.sectionSubtitle')}</p>
          </div>
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-4xl text-lg text-neutral-600">{t('voc.sectionSubtitle')}</p>
          </div>
