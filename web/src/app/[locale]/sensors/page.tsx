        ...
        <div className="mx-auto max-w-container px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={idx}
                className="group rounded-xl border border-neutral-200 bg-gradient-to-br from-neutral-50 to-white p-6 transition-all duration-300 hover:border-primary-500 hover:shadow-lg"
              >
