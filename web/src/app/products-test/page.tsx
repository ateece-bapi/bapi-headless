  ...
  if (!process.env.NEXT_PUBLIC_WORDPRESS_GRAPHQL) {
    return (
      <div className="container mx-auto px-4 py-8">
        <h1 className="mb-6 text-3xl font-bold">Products Test</h1>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-lg font-bold text-green-600">{price || 'N/A'}</span>
                ...
                <p className="mt-2 text-sm text-gray-600">Type: {product.__typename}</p>
              </div>
            );
          })}
        </div>
