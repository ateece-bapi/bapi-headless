          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-3 gap-6 mt-12 pt-12 border-t border-white/20">
                <div>
                  <div className="text-3xl lg:text-4xl font-bold text-accent-500">5 min</div>
                  <div className="text-sm lg:text-base text-primary-100 mt-1">Setup Time</div>
                </div>
                <div>
                  <div className="text-3xl lg:text-4xl font-bold text-accent-500">5 Years</div>
                  <div className="text-sm lg:text-base text-primary-100 mt-1">Battery Life</div>
                </div>
                <div>
                  <div className="text-3xl lg:text-4xl font-bold text-accent-500">24/7</div>
                  <div className="text-sm lg:text-base text-primary-100 mt-1">Cloud Access</div>
                </div>
              </div>
            </div>
