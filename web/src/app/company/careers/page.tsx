      ...
      <section className="bg-gradient-to-r from-primary-700 via-primary-500 to-primary-700 py-16 text-white">
        <div className="mx-auto max-w-container px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <BriefcaseIcon className="mx-auto mb-4 h-16 w-16" />
      ...
      <section className="py-16">
        <div className="mx-auto max-w-content px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="rounded-xl bg-neutral-50 p-6 text-center">
              <MapPinIcon className="mx-auto mb-3 h-10 w-10 text-primary-500" />
            ...
            <div className="rounded-xl bg-neutral-50 p-6 text-center">
              <BriefcaseIcon className="mx-auto mb-3 h-10 w-10 text-primary-500" />
