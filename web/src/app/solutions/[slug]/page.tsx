...
const solutions = {
  healthcare: {
    ...
    hero: {
      ...
      description: 'Healthcare environments demand unwavering reliability. BAPI sensors deliver NIST-traceable accuracy for critical care areas, operating rooms, and pharmaceutical storage.',
    },
    challenges: [
      {
        title: 'Operating Room Pressurization',
        description: 'Maintain positive/negative pressure differentials to prevent infection spread',
  ...
  'data-centers': {
    ...
    hero: {
      ...
      description: 'Data center cooling represents 40% of total energy costs. BAPI sensors provide the precision monitoring needed to optimize HVAC systems and reduce Power Usage Effectiveness (PUE).',
    },
    challenges: [
      {
  ...
  'commercial-real-estate': {
    ...
    hero: {
      ...
      description: 'Commercial buildings face dual pressures: maximizing tenant satisfaction while minimizing operating costs. BAPI sensors enable both through precise environmental control.',
    },
    challenges: [
      {
  ...
  'manufacturing-industrial': {
    ...
    hero: {
      ...
      description: 'Manufacturing processes demand stable environmental conditions. BAPI sensors provide the accuracy and reliability needed for quality control and regulatory compliance.',
    },
    challenges: [
      {
    ...
    outcomes: {
      ...
      details: 'Certified sensors for pharmaceutical, semiconductor, and medical device manufacturing'
    },
    features: [
          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 lg:w-20 lg:h-20 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                <IconComponent className="w-8 h-8 lg:w-10 lg:h-10 text-white" strokeWidth={2} />
              </div>
              <div>
                <p className="text-accent-400 font-semibold text-sm lg:text-base mb-1">Industry Solutions</p>
                <h1 className="text-3xl lg:text-5xl font-bold text-white">{solution.title}</h1>
              </div>
            </div>
            <p className="text-xl lg:text-2xl text-primary-100 font-semibold mb-4">{solution.subtitle}</p>
            <p className="text-2xl lg:text-3xl font-bold text-white mb-4">{solution.hero.tagline}</p>
      ...
      <section className="w-full bg-white py-16 lg:py-20">
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-4">Critical Challenges & BAPI Solutions</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {solution.challenges.map((challenge, index) => (
              <div key={index} className="bg-neutral-50 rounded-xl p-6 lg:p-8 border border-neutral-200 hover:border-primary-500 transition-all duration-300">
                <h3 className="text-xl lg:text-2xl font-bold text-neutral-900 mb-3">{challenge.title}</h3>
                <p className="text-neutral-700 mb-4">{challenge.description}</p>
                <div className="bg-primary-50 border-l-4 border-primary-500 p-4 rounded">
                  <p className="text-sm font-semibold text-primary-700 mb-1">BAPI Solution:</p>
      ...
      <section className="w-full bg-primary-600 py-16 lg:py-20">
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-8">Proven Results</h2>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 lg:p-12 border border-white/20">
              <div className="text-6xl lg:text-7xl font-bold text-accent-400 mb-4">{solution.outcomes.stat}</div>
              <div className="text-2xl lg:text-3xl font-bold text-white mb-4">{solution.outcomes.label}</div>
      ...
      <section className="w-full bg-neutral-50 py-16 lg:py-20">
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl lg:text-4xl font-bold text-neutral-900 mb-8 text-center">Key Features & Capabilities</h2>
            <div className="grid md:grid-cols-2 gap-4">
              {solution.features.map((feature, index) => (
                <div key={index} className="flex items-start gap-3 bg-white rounded-lg p-4 border border-neutral-200">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-accent-500 hover:bg-accent-600 text-neutral-900 font-bold text-lg rounded-lg transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105"
              >
              ...
              <Link
                href="/products"
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-primary-500 text-primary-600 hover:bg-primary-50 font-bold text-lg rounded-lg transition-all duration-300"
              >
      ...
      <section className="w-full bg-neutral-100 py-12 border-t border-neutral-200">
        <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-neutral-600">
            <span className="font-semibold">Case Studies Coming Soon:</span> Real-world implementations, ROI data, and customer testimonials
          </p>
        </div>
      </section>
    </div>
