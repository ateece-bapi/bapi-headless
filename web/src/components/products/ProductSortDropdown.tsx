  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      <button
        ...
        className="inline-flex items-center justify-between w-full sm:w-auto min-w-[200px] px-4 py-2 text-sm font-medium text-neutral-700 bg-white border border-neutral-300 rounded-lg hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors"
        aria-haspopup="true"
      ...
      >
        ...
        <svg
          className={`ml-2 w-5 h-5 text-neutral-500 transition-transform ${isOpen ? 'rotate-180' : ''}`}
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
