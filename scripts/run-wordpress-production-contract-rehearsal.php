<?php
/**
 * Dry-run a schema-v2 production-contract package against the disposable rehearsal clone.
 *
...
if (($args[2] ?? 'dry-run') !== 'dry-run') {
    fwrite(STDERR, "ERROR: The production-contract rehearsal wrapper permits dry-run mode only.\n");
    exit(1);
}
