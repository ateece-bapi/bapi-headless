...
import { ArrowRight, Wind, Leaf, Heart, Building, Users, TrendingUp } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-3 gap-6 mt-12 pt-12 border-t border-white/20">
                <div>
                  <div className="text-3xl lg:text-4xl font-bold text-accent-500">±50 ppm</div>
                  <div className="text-sm lg:text-base text-primary-100 mt-1">CO₂ Accuracy</div>
                </div>
                <div>
                  <div className="text-3xl lg:text-4xl font-bold text-accent-500">ASHRAE</div>
                  <div className="text-sm lg:text-base text-primary-100 mt-1">Compliant</div>
                </div>
                <div>
                  <div className="text-3xl lg:text-4xl font-bold text-accent-500">30%</div>
                  <div className="text-sm lg:text-base text-primary-100 mt-1">Energy Savings</div>
                </div>
              </div>
            </div>
