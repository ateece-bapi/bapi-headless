...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Complete catalog of Material Symbols icons used in BAPI Headless. All icons are from Google Material Symbols (Rounded variant, 400 weight, no fill, 24dp optical size) with consistent sizing via Tailwind classes.',
      },
    },
  },
...
const IconDisplay = ({
  ...
  return (
    <div className="group relative flex flex-col items-center gap-2 rounded-lg border border-neutral-200 p-4 transition-all hover:border-primary-500 hover:bg-neutral-50">
      <Icon style={{ fontSize: size }} aria-hidden="true" />
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 p-6">
            <ShoppingCartIcon className="text-base" aria-hidden="true" />
            <CheckIcon className="text-base" aria-hidden="true" />
            <InfoIcon className="text-base" aria-hidden="true" />
            <ArrowRightIcon className="text-base" aria-hidden="true" />
            <PackageIcon className="text-base" aria-hidden="true" />
          </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 p-6">
            <ShoppingCartIcon className="text-[32px]" aria-hidden="true" />
            <CheckIcon className="text-[32px]" aria-hidden="true" />
            <InfoIcon className="text-[32px]" aria-hidden="true" />
            <ArrowRightIcon className="text-[32px]" aria-hidden="true" />
            <PackageIcon className="text-[32px]" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 p-6">
            <ShoppingCartIcon className="text-5xl" aria-hidden="true" />
            <CheckIcon className="text-5xl" aria-hidden="true" />
            <InfoIcon className="text-5xl" aria-hidden="true" />
            <ArrowRightIcon className="text-5xl" aria-hidden="true" />
            <PackageIcon className="text-5xl" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 bg-white p-6">
            <ShoppingCartIcon className="text-primary-500 text-[32px]" aria-hidden="true" />
            <CheckCircleIcon className="text-primary-500 text-[32px]" aria-hidden="true" />
            <PackageIcon className="text-primary-500 text-[32px]" aria-hidden="true" />
            <ThermometerIcon className="text-primary-500 text-[32px]" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 bg-white p-6">
            <AlertTriangleIcon className="text-accent-500 text-[32px]" aria-hidden="true" />
            <BellIcon className="text-accent-500 text-[32px]" aria-hidden="true" />
            <AwardIcon className="text-accent-500 text-[32px]" aria-hidden="true" />
            <ZapIcon className="text-accent-500 text-[32px]" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 bg-white p-6">
            <CheckCircleIcon className="text-success-500 text-[32px]" aria-hidden="true" />
            <CheckIcon className="text-success-500 text-[32px]" aria-hidden="true" />
            <ThumbsUpIcon className="text-success-500 text-[32px]" aria-hidden="true" />
            <ShieldIcon className="text-success-500 text-[32px]" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 bg-white p-6">
            <AlertCircleIcon className="text-warning-500 text-[32px]" aria-hidden="true" />
            <AlertTriangleIcon className="text-warning-500 text-[32px]" aria-hidden="true" />
            <ClockIcon className="text-warning-500 text-[32px]" aria-hidden="true" />
            <InfoIcon className="text-warning-500 text-[32px]" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 bg-white p-6">
            <XCircleIcon className="text-error-500 text-[32px]" aria-hidden="true" />
            <XIcon className="text-error-500 text-[32px]" aria-hidden="true" />
            <AlertTriangleIcon className="text-error-500 text-[32px]" aria-hidden="true" />
            <Trash2Icon className="text-error-500 text-[32px]" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg border border-neutral-200 bg-white p-6">
            <SettingsIcon className="text-neutral-700 text-[32px]" aria-hidden="true" />
            <FilterIcon className="text-neutral-700 text-[32px]" aria-hidden="true" />
            <SearchIcon className="text-neutral-700 text-[32px]" aria-hidden="true" />
            <MenuIcon className="text-neutral-700 text-[32px]" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
        ...
        <div>
          ...
          <div className="flex items-center gap-6 rounded-lg bg-neutral-900 p-6">
            <ShoppingCartIcon className="text-white text-[32px]" aria-hidden="true" />
            <PackageIcon className="text-white text-[32px]" aria-hidden="true" />
            <HeartIcon className="text-white text-[32px]" aria-hidden="true" />
            <UserIcon className="text-white text-[32px]" aria-hidden="true" />
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
...
export const CommonUseCases: Story = {
        ...
        <div>
          ...
          <div className="rounded-lg border border-neutral-200 p-6">
            <button
              ...
              disabled
            >
              <Loader2Icon className="text-base animate-spin" aria-hidden="true" />
        ...
        <div>
          ...
          <div className="rounded-lg border border-neutral-200 p-6">
            <div className="flex items-center gap-3 rounded-lg bg-success-50 p-4">
              <CheckCircleIcon className="text-success-500" aria-hidden="true" />
        ...
        <div>
          ...
          <div className="rounded-lg border border-neutral-200 p-6">
            <div className="flex items-center gap-2">
              ...
              >
                <HeartIcon className="text-base" aria-hidden="true" />
              </button>
              <button
                type="button"
                ...
                className="rounded-lg border border-neutral-300 p-2 hover:border-primary-500 hover:text-primary-500"
              >
                <GitCompareIcon className="text-base" aria-hidden="true" />
              </button>
              <button
                type="button"
                className="flex-1 rounded-lg bg-primary-500 px-4 py-2 text-white hover:bg-primary-600"
              >
                <ShoppingCartIcon className="text-base inline" aria-hidden="true" /> Add to Cart
              </button>
            </div>
          </div>
          <pre className="mt-2 rounded bg-neutral-900 p-3 text-sm text-white">
  ...
  <button>
    <ShoppingCartIcon className="text-base" aria-hidden="true" /> Add to Cart
  </button>
</div>`}
          </pre>
        </div>
          ...
          <div className="rounded-lg border border-neutral-200 p-6">
            <div className="grid grid-cols-4 gap-4">
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 rounded-lg p-4 hover:bg-primary-50"
              >
                <DropletsIcon className="text-primary-500 text-[32px]" aria-hidden="true" />
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 rounded-lg p-4 hover:bg-primary-50"
              >
                <GaugeIcon className="text-primary-500 text-[32px]" aria-hidden="true" />
              ...
              <button
                ...
                className="flex flex-col items-center gap-2 rounded-lg p-4 hover:bg-primary-50"
              >
                <WindIcon className="text-primary-500 text-[32px]" aria-hidden="true" />
      ...
      <div className="space-y-8">
        ...
        <div className="rounded-lg border-2 border-accent-500 bg-accent-50 p-6">
          <div className="flex items-start gap-3">
            <AlertTriangleIcon className="mt-1 text-accent-600" />
            <div>
                ...
                return (
                  <div key={icon.order} className="flex flex-col items-center gap-3">
                    <div className="flex h-16 w-16 items-center justify-center">
                      <LucideIcon className="text-primary-500 text-[40px]" />
                    </div>
                    <div className="text-center">
  ...
  // ...7 categories total (Sensors in brand guidelines but not yet in menu)
        ...
        <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-6">
          ...
          <div className="mb-4 space-y-2 text-sm">
            <div className="flex items-center gap-2">
              <XIcon className="text-error-500 text-base" />
              <span>
        ...
        <div className="rounded-lg border-2 border-success-500 bg-success-50 p-6">
          ...
          <div className="grid grid-cols-1 gap-2 text-sm md:grid-cols-2">
            <div className="flex items-start gap-2">
              <CheckCircleIcon className="mt-0.5 shrink-0 text-success-600 text-base" aria-hidden="true" />
