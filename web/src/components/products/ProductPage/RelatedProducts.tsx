        ...
        {related.map((product) => (
          <div key={product.id} className="border rounded-lg p-4 bg-white hover:shadow flex flex-col h-full">
            ...
            <div className="mt-auto flex gap-2">
              <a href={`/en/product/${product.slug}`} className="bg-neutral-100 text-primary-700 px-3 py-1 rounded text-xs font-semibold hover:bg-primary-50 transition" aria-label={`View ${product.name}`}>View</a>
