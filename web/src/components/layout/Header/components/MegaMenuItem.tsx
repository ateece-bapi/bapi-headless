                ...
                <div className="relative z-10 space-y-4">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center p-6">
                        <div className="relative h-full w-full">
                          <Image
                            ...
                            alt={item.megaMenu.featured.logoAlt || ''}
                            fill
                  ...
                  <div className="flex items-center gap-2 rounded-lg border border-primary-200/50 bg-white/60 px-3 py-2 backdrop-blur-sm">
                    ...
                    <div className="text-xs">
                      <p className="font-bold text-neutral-900">Changing the way you think about sensors.</p>
                      <p className="text-neutral-700">Precision sensor solutions since 1993</p>
                    </div>
                  </div>
